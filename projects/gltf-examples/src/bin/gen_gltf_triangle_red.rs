...
fn main() {
    let output_file = "triangle_red.gltf";
    ...
    let red_material = root.push(gltf_json::material::Material {
        pbr_metallic_roughness: gltf_json::material::PbrMetallicRoughness {
            base_color_factor: gltf_json::material::PbrBaseColorFactor([1.0, 0.0, 0.0, 1.0]),
            ..Default::default()
        },
        ..Default::default()
    });
